...
public class HardController {
    ...
    public Label HealthWall4;
    public Label DangerLevelWall4;
    public VBox VBoxLane4;
    public VBox VBoxLane5;
    public RadioButton RadioLane4;
    public RadioButton RadioLane5;
    public Label HealthWall5;
    public Label DangerLevelWall5;
    @FXML
    private Label score;
    @FXML
    private Label turns;
    ...
    public void initialize(){
        ...
        RadioLane4.setToggleGroup(t);
        RadioLane5.setToggleGroup(t);
    ...
    public void Turn() {
        ...
        HealthWall4.setText("Health: " + String.valueOf(battle.getOriginalLanes().get(3).getLaneWall().getCurrentHealth()));
        HealthWall5.setText("Health: " + String.valueOf(battle.getOriginalLanes().get(4).getLaneWall().getCurrentHealth()));
